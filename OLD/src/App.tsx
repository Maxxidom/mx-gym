...
export default function App() {
  ...
  const renderHome = () => (
    <div className="min-h-screen text-white pb-28" style={{ backgroundColor: theme.bg.darkest }}>
      <header className="px-5 pt-14 pb-6">
        ...
        <h1 className="text-3xl font-bold mt-1">Тренировка</h1>
      </header>
  ...
  const renderEditWorkout = () => {
    ...
    return (
      <div className="min-h-screen text-white pb-8" style={{ backgroundColor: theme.bg.darkest }}>
        <header className="sticky top-0 backdrop-blur-xl z-40 px-5 pt-14 pb-4" style={{ backgroundColor: `${theme.bg.darkest}ee`, borderBottom: `1px solid ${theme.bg.medium}` }}>
          <div className="flex items-center justify-between">
            <button 
              onClick={() => {
  ...
  // Exercise Screen (Full-screen modal)
  const renderExercise = () => {
    ...
    return (
      <div className="fixed inset-0 text-white z-50 flex flex-col" style={{ backgroundColor: theme.bg.darkest }}>
        <header className="px-5 pt-14 pb-4" style={{ borderBottom: `1px solid ${theme.bg.medium}` }}>
          <div className="flex items-center justify-between">
            <button 
              onClick={() => {
                setActiveExerciseId(null);
          ...
          <div className="mt-4">
            <span 
              ...
              style={{ backgroundColor: category.bg, color: category.color }}
            >
              {template.machineNumber} • {category.label}
            </span>
            <h1 className="text-2xl font-bold mt-3">{template.name}</h1>
          ...
          {/* Timer Display */}
          <div className="mt-4 rounded-2xl p-4" style={{ backgroundColor: theme.bg.dark }}>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div 
              ...
              <div className="flex gap-2">
                {timerStatus === 'idle' && (
                  <button
                    ...
                    className="text-white px-6 py-3 rounded-xl font-bold flex items-center gap-2"
                ...
                {timerStatus === 'running' && (
                  <button
                    ...
                    className="bg-yellow-600 text-white px-5 py-3 rounded-xl font-bold flex items-center gap-2 active:bg-yellow-500"
                  >
                    {Icons.pause}
                    <span>Отложить</span>
                  </button>
          ...
          {lastWorkout && (
            <div className="mt-4 rounded-xl p-4" style={{ backgroundColor: theme.bg.dark }}>
              <p className="text-gray-500 text-xs font-medium mb-2">ПОСЛЕДНЯЯ ТРЕНИРОВКА</p>
              <div className="flex gap-3 overflow-x-auto pb-1">
                {lastWorkout.sets.map((s, i) => (
                  <div key={i} className="rounded-lg px-3 py-2 text-center flex-shrink-0" style={{ backgroundColor: theme.bg.medium }}>
                    <p className="text-lg font-bold">{s.weight}</p>
                    <p className="text-gray-400 text-xs">{s.reps} повт.</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="flex-1 overflow-auto px-5 py-4">
            ...
            {activeExercise.sets.map((set, index) => (
              ...
              >
                <div className="flex items-center justify-between mb-5">
                  <span className="text-gray-400 font-bold text-lg">Подход {index + 1}</span>
                  {activeExercise.sets.length > 1 && (
                    <button
                      onClick={() => handleDeleteSet(activeExercise.id, set.id)}
                      className="text-gray-600 active:text-red-500 p-2"
                    >
                      {Icons.trash}
                    </button>
                  )}
                ...
                <div className="grid grid-cols-2 gap-4">
                  {/* Reps */}
                  <div>
                    <label className="text-gray-500 text-xs font-medium block mb-2 text-center uppercase tracking-wide">Повторения</label>
                    <div className="flex items-center rounded-2xl" style={{ backgroundColor: theme.bg.medium }}>
                      <button
                        ...
                        className="w-14 h-14 flex items-center justify-center rounded-l-2xl flex-shrink-0"
                        style={{ color: theme.accent }}
                      >
                        {Icons.minus}
                      </button>
                      <div className="input-wrap">
                        <input
                          ...
                          className="w-16 max-w-16 bg-transparent text-center text-2xl font-bold outline-none"
                          style={{ textAlign: 'center' }}
                        />
                      </div>
                      <button
                        onClick={() => handleUpdateSet(activeExercise.id, set.id, { reps: set.reps + 1 })}
                        className="w-14 h-14 flex items-center justify-center rounded-r-2xl flex-shrink-0"
                        style={{ color: theme.accent }}
                      >
                        {Icons.plus}
                      </button>
                  ...
                  {/* Weight */}
                  <div>
                    <label className="text-gray-500 text-xs font-medium block mb-2 text-center uppercase tracking-wide">Вес (кг)</label>
                    <div className="flex items-center rounded-2xl" style={{ backgroundColor: theme.bg.medium }}>
                      <button
                        onClick={() => handleUpdateSet(activeExercise.id, set.id, { weight: Math.max(0, set.weight - 2.5) })}
                        className="w-14 h-14 flex items-center justify-center text-orange-400 rounded-l-2xl flex-shrink-0"
                      >
                        {Icons.minus}
                      </button>
                      <div className="input-wrap">
                      ...
                      <button
                        ...
                        className="w-14 h-14 flex items-center justify-center text-orange-400 rounded-r-2xl flex-shrink-0"
                      >
                        {Icons.plus}
                      </button>
                    </div>
                ...
                <button
                  ...
                  className="w-full mt-5 py-4 rounded-xl font-bold transition-all flex items-center justify-center gap-2"
                  style={{
                    backgroundColor: set.completed ? '#10b981' : theme.bg.light,
                    color: set.completed ? 'white' : 'gray'
                  }}
                >
                  {set.completed && Icons.check}
                  {set.completed ? 'Выполнено' : 'Отметить выполненным'}
                </button>
              </div>
            ))}
          </div>
          ...
          <button
            ...
            className="w-full mt-4 py-4 border-2 border-dashed rounded-2xl text-gray-400 font-semibold flex items-center justify-center gap-2"
            style={{ borderColor: theme.bg.light }}
          >
            {Icons.plus}
            Добавить подход
        ...
        <div className="p-5" style={{ borderTop: `1px solid ${theme.bg.medium}` }}>
          <button
  ...
  const renderHistory = () => {
    ...
    return (
      <div className="fixed inset-0 z-[60] overflow-auto" style={{ backgroundColor: theme.bg.darkest }}>
        <header className="sticky top-0 px-5 pt-14 pb-4" style={{ backgroundColor: theme.bg.darkest, borderBottom: `1px solid ${theme.bg.medium}` }}>
          <div className="flex items-center justify-between">
          ...
          <h1 className="text-xl font-bold mt-4">История: {template.name}</h1>
        </header>
